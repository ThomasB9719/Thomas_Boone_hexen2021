        ...
        private void InitializeMoves()
        {
            _moves.Add(PieceType.Pawn, new ConfigurableMove<TPosition,TPiece>(/*_replayManager,*/
                (b,g,p) => new MovementHelper<TPosition,TPiece>(b, g, p)
                       ...
                       .NorthWest(1, MovementHelper<TPosition, TPiece>.IsEmptyTile)
                    .SouthEast(1, MovementHelper<TPosition, TPiece>.IsEmptyTile)
                    .SouthWest(1, MovementHelper<TPosition, TPiece>.IsEmptyTile)
                    .East(1, MovementHelper<TPosition, TPiece>.IsEmptyTile)
                    .West(1, MovementHelper<TPosition, TPiece>.IsEmptyTile)
